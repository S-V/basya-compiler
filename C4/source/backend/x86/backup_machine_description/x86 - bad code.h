/* The x86 architecture instructions */

// 2008.12.8 : rule cannot have dtors, only ctors and actions!!!
// instructions ( '[' ... ']' ) can have any of these.
// only instructions can have side effects!
%operator	nop
...
/** /
[ stmt : assign( address, add( assign( address_32, mem ), rc ) )
   "hurrah"
   <7>
]
/** /
[ stmt : assign( address, add( assign( address_32, mem ), mrc ) )
   "hurrah"
   <7>
]
/** /
[ %0 : assign( mem, add(assign(mem, reg), rc) )
   "hurrah"
   <7>
]
/**/
...
float_const: fconst "dword ptr %0"	%ctor{ float value = insn->GetFloatValue();
...
==================================
*/
start_of_function:	func_start	"%0"
end_of_function:	func_end	"%0"

[ stmt: start_of_function
	"_%0 proc"
	<15>
	{ 
		//TODO:
